...
@media (min-width:320px)  { .img-falasifa{height: 200px;width: 200px; object-fit: contain;} .hidef{display: none} }
@media (min-width:481px)  { .img-falasifa{height: 200px;width: 200px; object-fit: contain;} .hidef{display: none} }
/* POTRAIT TABLET , IPAD , LANDSCAPE PHONE */
@media (min-width:641px)  { .img-falasifa{height: 250px;width: 250px; object-fit: contain;} .hidef{display: block}}
@media (min-width:961px)  { .img-falasifa{height: 250px;width: 250px; object-fit: contain;} .hidef{display: block}}
@media (min-width:1025px) { .img-falasifa{height: 250px;width: 250px; object-fit: contain;} .hidef{display: block}}
@media (min-width:1281px) { .img-falasifa{height: 250px;width: 250px; object-fit: contain;} .hidef{display: block}}
    </style>
</head>
<body>
    <div class="container">
